...
import emu.grasscutter.game.dungeons.challenge.trigger.ElementReactionCountTrigger;
...
public class ElementReactionCountChallengeFactoryHandler implements ChallengeFactoryHandler{
    ...
    public boolean isThisType(ChallengeType challengeType) {
        return challengeType == CHALLENGE_ELEMENT_REACTION_COUNT;
    }

    // indices: [currentChallengeIndex, currentChallengeId, fatherChallengeIndex]
    // params: [reactionType, goal, unused1, unused2, successCount, failCount]
    @Override
    public WorldChallenge build(List<Integer> indices, List<Integer> params, Scene scene, SceneGroup group) {
        return new ChildChallenge(
            ...
            0,
            params.get(1),
            List.of(new ElementReactionCountTrigger(1, params.get(0))),
